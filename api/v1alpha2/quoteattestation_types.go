...
// ConditionReason is the short machine readable reason for
...
type QuoteAttestationSpec struct {
	...
	// Nonce base64-encoded nonce used for generating the SGX Quote.
	// This is required for verifying the provided SGX quote by
	// the key server(s).
	// +kubebuilder:listType=atomic
