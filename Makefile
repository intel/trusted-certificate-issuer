...
## Rename CRDs identical to names generated by the controller_gen; remove prefixed type information 
	@cd deployment/crds; for f in $$(ls ./apiextensions*.yaml); do newname=$$(echo $$f|sed -e 's|apiextensions.k8s.io_v1_customresourcedefinition_\(.*\).\(tcs.intel.com*\)|\2_\1|g'); mv $$f $$newname; done
